...
if page == "Индексация документов":
    ...
    tag_option = st.selectbox(
        ...
        options=["CRM", "Регистрация", "Личный кабинет"],  # Пример существующих тегов
...
# -------------------------------
    ...
    available_tags = ["CRM", "Регистрация", "Личный кабинет"]  # Пример существующих тегов
    ...
    if st.button("Найти"):
        if query_text:
            ...
            results = [
                {"content": "Пример параграфа 1", "tag": "CRM"},
                {"content": "Пример параграфа 2", "tag": "Регистрация"},
                {"content": "Пример параграфа 3", "tag": "Личный кабинет"},
            ]
